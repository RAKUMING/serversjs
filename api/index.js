...
app.get("/liquidaciones", async (req, res) => {
    try {
        ...
        const url = `https://api.coinalyze.net/v1/liquidation-history?api_key=${apiKey}&symbols=BTCUSDT_PERP.0&interval=1min&from=${from}&to=${to}&convert_to_usd=false&t=${Date.now()}`;
